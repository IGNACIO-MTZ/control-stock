...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
       ...
       /* ImageIcon imagenIcon = new ImageIcon("C:/Users/ccnobe/eclipse-workspace/control-de-stock/inventory.jpg");
        Image imagen = imagenIcon.getImage().getScaledInstance(200, 200, java.awt.Image.SCALE_SMOOTH);
        ImageIcon nuevaImagen = new ImageIcon(imagen);

        JLabel labelImagen = new JLabel(nuevaImagen);
        labelImagen.setBounds(400, 15, 300, 175);
        container.add(labelImagen);
        */
    }
    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                ...
                }, () -> JOptionPane.showConfirmDialog(this, "Por favor, elije un item"));
    }
                ...
                .ifPresentOrElse(fila -> {
                   ...
                   var filasModificadas = this.productoController.eliminar(id);
                    ...
                    JOptionPane.showMessageDialog(this,
                    		String.format("%d item eliminado con exito!", filasModificadas));
                },()->JOptionPane.showConfirmDialog(this, "Por favor elige un item"));
    }
